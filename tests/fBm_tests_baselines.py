...
from whittlehurst import whittle, variogram, tdml, fbm_gen
    ...
    general_plot(
        {
            ...
            "yscale": "log",
            "title": "",
            "fname": "fBm_baselines_calc_times",
            "dirname": plot_dir,
            "markers": None,
            "legend": {
                "location": "top_left",
    ...
    general_plot(
        {
            ...
            "yscale": "log",
            "title": "",
            "fname": "fBm_baselines_RMSE_compute",
            "dirname": plot_dir,
            "markers": None,
            "legend": {
                "location": "top_left",
